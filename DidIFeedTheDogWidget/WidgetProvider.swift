    ...
    func placeholder(in context: Context) -> WidgetEntry {
        ...
        return WidgetEntry(date: now, pets: [
            PetSnapshot(data: PetWidgetData(id: UUID(), name: "Max", photoData: nil,
                        lastFedDate: now.addingTimeInterval(-1800), isFasting: false, scheduleTimes: [], thresholdHours: 12, hasMedicationDue: false, nextMedicationDueDate: nil)),
            PetSnapshot(data: PetWidgetData(id: UUID(), name: "Bailey", photoData: nil,
                        lastFedDate: now.addingTimeInterval(-32400), isFasting: false, scheduleTimes: [], thresholdHours: 12, hasMedicationDue: false, nextMedicationDueDate: nil))
        ], isPro: readIsPro())
    }
