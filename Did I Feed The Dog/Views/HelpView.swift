    ...
    private var feedingStatusSection: some View {
        Section("Feeding Status") {
            ...
            FAQRow(
                ...
                answer: "Fasting Mode is used when your dog shouldn't eat — for example, before a vet visit or due to illness. It displays a \"Do Not Feed\" warning on the card and pauses all feeding reminders and overdue alerts for that dog. Tapping the Log Meal button while fasting shows a prompt where you can end fasting if needed. Turn fasting on or off by long-pressing a dog's card on the dashboard, or in Settings -> Dogs -> [dog's name] -> Health."
            )
            FAQRow(
