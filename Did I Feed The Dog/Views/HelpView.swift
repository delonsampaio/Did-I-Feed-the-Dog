...
struct HelpView: View {
    ...
    private var feedingStatusSection: some View {
        Section("Feeding Status") {
            ...
            FAQRow(
                ...
                answer: "Yes. Tap a dog's card header to open their history, then swipe left on any entry. You'll see an Edit option to change the meal type and notes, and Delete options to remove the entry (and optionally restore the food portion)."
            )
            FAQRow(
            ...
            FAQRow(
                ...
                answer: "Yes. Go to Settings -> Dogs -> [dog's name] -> Medical -> Medications and tap Add Medication. Enter the name, optional dose, and how often it needs to be given (3 times daily, twice daily, daily, every 2 days, every 3 days, or weekly). When a dose is due, a purple 💊 banner appears on your dog's card — tap it to log the dose. Pro users can enable a Dose Reminder push notification. By default it fires at the interval after your last logged dose (e.g. 24 hours later for a daily med), but you can also set a fixed time of day — for example, always remind at 8 AM."
            )
        }
    }
    ...
    private static let allFAQs: [FAQItem] = [
            ...
            .init(section: "Feeding Status", question: "Can I track my dog's medications and supplements?", answer: "Yes. Go to Settings -> Dogs -> [dog's name] -> Medical -> Medications and tap Add Medication. Enter the name, optional dose, and how often it needs to be given (3 times daily, twice daily, daily, every 2 days, every 3 days, or weekly). When a dose is due, a purple 💊 banner appears on your dog's card — tap it to log the dose. Pro users can enable a Dose Reminder push notification. By default it fires at the interval after your last logged dose (e.g. 24 hours later for a daily med), but you can also set a fixed time of day — for example, always remind at 8 AM."),
            ...
            .init(section: "Food Stock", question: "What is the Low Stock Threshold?", answer: "When a dog's stock drops to or below this number, a warning banner appears on their card and a push notification is sent (if enabled). Adjust it in Settings -> Notifications.", isPro: true),
            ...
            .init(section: "Feeding Reminders", question: "What is Per Dog mode?", answer: "Each dog has their own reminder schedule. Tap the dog's name in Settings -> Feeding Reminders (or tap the dog's name in Settings -> Dogs) to set their individual times.", isPro: true),
            .init(section: "Feeding Reminders", question: "How many reminder times can I set?", answer: "Free users can set 1 daily reminder time. Pro users can set up to 3 per schedule. Most households need a morning and evening reminder, but a midday one is available too.", isPro: true),
            ...
            .init(section: "Notifications", question: "What is the Overdue Notification?", answer: "An alert sent when a dog hasn't been fed and is past due (default 12 hours). It only alerts you once, and goes away automatically when you log a meal. Turn it off in Settings -> Notifications -> Overdue Notification.", isPro: true),
            .init(section: "Notifications", question: "What is the App Icon Badge?", answer: "The red number shown on the app's icon on your home screen. It shows how many of your dogs are currently overdue for a meal. It updates automatically when you open the app or log a feeding. Turn it off in Settings -> Notifications -> App Icon Badge.", isPro: true),
