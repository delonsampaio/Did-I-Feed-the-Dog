...
struct HelpView: View {
    ...
    private var siriSection: some View {
        Section("Siri & Shortcuts") {
            ...
            FAQRow(
                ...
                answer: "Say \"Feed Luna in Fed The Dog?\", \"Mark Luna as fed in Fed The Dog?\", or \"Log Luna's meal in Fed The Dog?\". Siri will automatically guess the meal type based on the time of day! Siri will even tell you your remaining food stock afterward."
            )
            FAQRow(
            ...
            FAQRow(
                ...
                answer: "The app automatically picks one based on the time of day — Breakfast before 11 AM, Lunch from 11 AM to 4 PM, Dinner from 4 PM to 11 PM, and Snack overnight."
            )
            FAQRow(
    ...
    private let allFAQs: [FAQItem] = [
            ...
            .init(section: "Siri & Shortcuts", question: "How do I log a feeding with Siri?", answer: "Say \"Feed Luna in Fed The Dog?\", \"Mark Luna as fed in Fed The Dog?\", or \"Log Luna's meal in Fed The Dog?\". Siri will automatically guess the meal type based on the time of day! Siri will even tell you your remaining food stock afterward."),
            ...
            .init(section: "Siri & Shortcuts", question: "What meal type does Siri use if I don't say one?", answer: "The app automatically picks one based on the time of day — Breakfast before 11 AM, Lunch from 11 AM to 4 PM, Dinner from 4 PM to 11 PM, and Snack overnight."),
